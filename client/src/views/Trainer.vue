<template>
    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            <!-- Single Advisor-->
            <div v-for="trainer in trainers" class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s"
                    style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    <!-- Team Thumb-->
                    <div class="advisor_thumb"><img :src="trainer.imageUrl" alt="" style="height: 350px;">
                        <!-- Social Info-->
                    ...
                    <div class="single_advisor_details_info">
                        <h6>{{ trainer.name }}</h6>
                        <p class="designation">{{ trainer.gender }}</p>
                    </div>
                    <div>
                        <button @click.prevent="handleHiringPt(trainer.id)" type="button" class="btn btn-danger">Hire Me</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    methods: {
        ...mapActions(useAppStore, ['getTrainer', 'hirePt']),
