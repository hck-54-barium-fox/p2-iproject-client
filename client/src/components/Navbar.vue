        ...
        <section class="relative mx-auto">
            ...
            <nav class="flex justify-between bg-gray-900 text-white w-screen">
                <div class="px-5 xl:px-12 py-6 flex w-full items-center">
                    <a class="text-3xl font-extrabold font-heading" style="font-family: Arial, Helvetica, sans-serif;" href="#">
                        <!-- <img class="h-9" src="logo.png" alt="logo"> -->
                        MORFEM
                    </a>
                    <!-- Nav Links -->
                    <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                        <li><a class="hover:text-gray-200" href="#" @click="home" >Home</a></li>
                        
                        <li><a class="hover:text-gray-200" href="#">Merchandise</a></li>
                        <li><a class="hover:text-gray-200" href="#" @click="contact">Contact</a></li>
                        <li><a class="hover:text-gray-200" href="#" @click="biography">Bio</a></li>
